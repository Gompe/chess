...
impl BitMove {
    pub const fn new_promotion_move(current_square: Square, next_square: Square, piece: Piece) -> BitMove {
        ...
        BitMove { payload: current_square.get_index() as u16 | ( (next_square.get_index() as u16) << 6 ) | piece_mask }
    }

    pub const fn new_normal_move(current_square: Square, next_square: Square) -> BitMove {
        BitMove { payload: (current_square.get_index() as u16) | ( (next_square.get_index() as u16) << 6 ) }
    }
...
impl BasicMove {
    ...
    pub const fn new_promotion_move(current_square: Square, next_square: Square, piece: Piece) -> BasicMove {
        BasicMove::PromotionMove(MoveCoordinates { current_square, next_square }, piece)
    }

    pub const fn new_normal_move(current_square: Square, next_square: Square) -> BasicMove {
        BasicMove::NormalMove(MoveCoordinates { current_square, next_square })
    }
